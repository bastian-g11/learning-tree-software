Feature: Employee Management & Trainings
...
Scenario: Add a note to a course
Given an user logged in with the email "user@test.com" with the role "USER"
When the user with the email "user@test.com" adds a note with the text "Keep in mind this section" to the course "HTML"
Then the note with the text "Keep in mind this section" added by the user with the email "user@test.com" to the course "HTML" should be added successfully
